...
def library():
    ...
    while exitRoom == False:
        ...
        if userAction.lower() == 'read book':
            ...
            print('Only you stand in the library, faced with a daunting task')
            
        elif userAction.lower() == 'go to desk':
            print('There is a note, "According to the legend, the Devitus that roams this abandoned base, can be summoned')
