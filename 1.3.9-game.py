...
def startGame(): #Function that starts the game, player has nothing, intro text.
    playerItems = []
    enteredRooms = []
    rocketOn = False
    endGame = False    
    ...
    while endGame == False: #While loop for entire game, game will function as long until user wins or loses. 
        while roomIn == 'hangar':
            exitRoom = False
            if 'hangar' not in enteredRooms: #Intro text for if the player hasn't entered hangar, then adds hangar to entered rooms.
                ...
                print('Back to the hangar. The rocket hasn\'t left without you.')  #Return text if player returns to the hangar.  
            while exitRoom == False:    #While loop of all possible actions in the hangar, some requiring items.            
                ...
                if userAction.lower() == 'look rocket':
                    ...
                    #This line will only work if player has the AXE bodyspray that activates rocketOn
                    exitRoom = True
                    roomIn = 'rocket'            
                    
                elif userAction.lower() == 'enter rocket' and rocketOn == False: #Other wise this. 
                    print('You can\'t enter the rocket without the launch codes.')
                    
                 #Cardinal Direction movement within map/rooms   
        ...
        while roomIn == 'cafe': #While loop for the cafe, room will be active as long as the player doesn't exit.
            exitRoom = False
            if 'room2' in enteredRooms:
                print('The cafe again. The pools of ketchup have dried a little.')
            if 'room2' not in enteredRooms: #adds room to enteredRooms and has an intro text.
                enteredRooms += ['room2']
            ...
            while exitRoom == False: #User actions for within the cafe, look (object) ect.
                userAction = raw_input('\n> ')
                if userAction.lower() == 'look table' or userAction.lower() == 'look coffee table':
                    ...
                    #Obtainable item, that plays a major role in winning the game.
                    ...
                    #Making sure the player gets the lighter, another way to get it.
                    print('\nYou went to get some bread but alas you got a lighter instead.')
                    playerItems += ['lighter']
                    
                
                    #Cardinal directions for this room, can be used to enter other rooms, thus ending the cafe while loop.
                elif userAction.lower() == 'go north':
                ...
                #Bridge while loop, will run while player hasn't exited the room. 
        while roomIn == 'bridge':
            exitRoom = False
            
            if 'bridge' in enteredRooms:
                print('The bridge again.')
            if 'bridge' not in enteredRooms: #Intro text for bridge, puts bridge into enteredRooms
            ...
            while exitRoom == False: #While loop for the player actions in the room.
                userAction = raw_input('\n> ')
                if userAction.lower() == 'look rocket':#Looking at rocket
                    print('The rocket is inactive. Needs launch codes.') 
                            
                elif userAction.lower() == 'look around':
                    print('The bridge appears directed towards a large circular door. "Command Center," according to the sign')            
                    
                    #Cardinal directions the player can go to enter another room.
                elif userAction.lower() == 'go north': #There is no room here, just a funny text response.
               ...
               #157-161 commandCenter is a locked room, so in order for the player to enter he/she needs the ccKey to be in PlayerItems.     
                ...
                else: #If action is not in the elifs, this message appears, saying the player can't do that.  
                    print('Can\'t do that.')
                
        while roomIn == 'rocket': #Rocket room, can cause 2 endings. 
            exitShip = False
            ...
            while exitShip == False:
                userAction = raw_input('> ')
                if userAction.lower() == 'take off': #Takeoff text
                    ...
                    if 'axeSpray' in playerItems:#If the player picks up the AXE Spray in this ending they win.
                        ...
                        print('\nGAME WON')
                    else: #Otherwise the Devitus catches up and they lose. 
                ...
                elif userAction.lower() == 'exit ship': #Leaves ship
                    exitShip = True
                    roomIn = 'hangar'
        ...
        while roomIn == 'commandCenter':
            ...
            if 'cc' in enteredRooms:
                ...
                print('You have entered Command Control') #Intro text, describes this room, this room can only be entered with the ccKey.
                ...
                print('D̷̹͍̎̆́͘ͅͅE̵̛͙̭͖̥͖̳̠̗̦̮̒̀͊͐͋̽̀̀͒̾͝ͅḶ̸̛͔͑̅̅͌̋̔̅̔̉̈́̊͛͊͜͝ͅE̵̳̯͖̱̳̱͛T̵̢̞̳͉͉̫̱̹̿̿̀̍̌̎̃̽͑̉̅̃͝Ư̵̢͉̪͚̼͌̑͌͐̓̊̽̋͛͆̚͝͠Ş̸̗̗̹̿̾̀̄̔͛͋͝ ̴̳̩̠̪̒͒̀͂̽̅̚ͅD̶̢̒̓͋̉̍̓̽̓̾̆̇̈́̕͠͝Ȇ̵̳̯̠̬͈̺͈̬̜̞̎͑͒̈̓͒͑͋͆͜͝V̶̢̢̧̢̦̥͓͖͖̤̬͎̖̝͉̉͛̂̊̽͛̈̐̈́̀̔̓̄͘I̴̧̢̼͔̘̳̬̣̫̬͂̋̀͆͛T̷̰͚̻̐̎̎̀́̋̑̓̿̀̄́́̑Ủ̶̡͇̪͚͖̪̥̍͆̌͐̈̈̌͜Ş̷̛̰͙̣͖̲̙͉̰̗̫̮͖̗̈̉̎͠') #Glitch text to send a message, creepy for the player to read. 
            ...
            while exitRoom == False: #Actions the player can do in the Command Center granted they haven't left the room. 
                userAction = raw_input('\n> ')
                if userAction == 'look around':
                  ...
                  #Cardinal Directions, some are funny texts as the only way to leave is to go west.   
        ...
        while roomIn == 'library': #Library room, for all the things the player can do. 
            
            exitRoom = False
            print('\nThis is library. SHHHHHHH!')
            ...
            while exitRoom == False:
                userAction = raw_input('\n> ')
                if userAction.lower() == 'read book': #Easter egg for modern internet culture, not related to game. 
                ...
                elif userAction.lower() == 'look around': #description of the room. 
                    print('The bookshelves seem to go up forever.')
                        ...
                        if n.lower() == 'y':
                            #First major hint the player gets of how to beat the game, step by step. 
                    ...
                    # 1 of 3 candles the player has to obtain to trigger the excorsism ending.
        ...
        while roomIn == 'biosphere': #Biosphere room, player can obtain another candle here. 
            vineClimbed = False
            exitRoom = False
            if 'biosphere' in enteredRooms:
                print('The birds sing upon your return. The followable light is still ahead.')
                #Hints at what the player needs to do if he/she missed it the first time.
            else:
            ...
            while exitRoom == False: #Actions the player can do in this room. 
                userAction = raw_input('\n> ')
                ...
                if userAction.lower() == 'go east':
                    ...
                    #Another candle and it adds it to player items 2/3
                ...
                elif userAction.lower() == 'climb vine' and vineClimbed == False: #Some funny things the player can do. 
        ...
        while roomIn == 'boiler':
            exitRoom = False
            #This prints everytime because we want to make sure that the player can get the secret key, this could be the first room they enter.
            ...
            while exitRoom == False:
                ...
                if userAction.lower() == 'look around':
                    ...
                    #Secret Key opens the door in the storage closet, that triggers another ending for the player
                        print('You took the key.')
                        playerItems += ['secretKey']
                        
                elif userAction.lower() == 'take candle' and 'scentedCandle' not in playerItems: #Last candle player gets 3/3
                        print('You took the candle. Seems to be... maple syrup scented. Nice(?)')
                        playerItems += ['scentedCandle']
                #Cardinal Directions for the player to exit room, some are funny because the only way to leave is to go north.
                elif userAction.lower() == 'go north':
                        exitRoom = True
                        roomIn = 'hangar'
        ...
        while roomIn == 'lockerroom': 
            ...
            if 'lockerroom' not in enteredRooms:
                enteredRooms += ['lockerroom'] #Intro text as well as adding lockerroom to enteredRooms.
            ...
            while exitRoom == False:
                ...
                if userAction.lower() == 'go north':
                    ...
                    print('You gently arrange all three candles in your locker') #Placing candles, excorsism ending. 
                    candlesInLocker = True
                    
                elif userAction.lower() == 'light candles' and candlesInLocker:
                    #lighting candles, need lighter to do this, following lines give text for if the player doesn't have the required items.
                    ...
                    if candlesLit != True: #If candles aren't lit this doesn't work. 
                        print('Nothing happened...')
                    else: #Triggers excorsism ending and the player wins the game. 
        ...
        while roomIn == 'storageroom':
            ...
            while exitRoom == False:
                ...
                if (userAction.lower() == 'open door' and 'secretKey' in playerItems) or (userAction.lower() == 'use key' and 'secretKey' in playerItems) or (userAction.lower() == 'use secret key' and 'secretKey' in playerItems):
                    print('After a loud wooosh, all sound is gone. \nAs you shove open the door you fall and land on fresh moon surface, the door slamming behind you, oxygen escapes you in the burning temperatures of the moon as you face the sun. \n You collaspe, dead and numb. \n \n GAME OVER')
                    #4th ending, if player opens secret door they die. 
                    endGame = True
                    roomIn = ''
                    break
                #Actions for in the Storage room.
                elif userAction.lower() == 'open door' and 'secretKey' not in playerItems: #explains the secret door and how to enter.
                    ...
                    #Hinting at something of interest. 
                    ...
                    print('Nothing of interest.') #If the player looks through the shelves again and has the key.
                    
                elif userAction.lower() == 'take card' or userAction.lower() == 'take key card' or userAction.lower() == 'take key':
                    print('You took the key card.') #Player takes ccKey and it adds it to their items. 
                    playerItems += ['ccKey']
